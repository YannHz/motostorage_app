...
class RegistrarProductoActivity : AppCompatActivity() {
    ...
    // ViewModel — igual que en tus tareas de clase
    private lateinit var productoViewModel: ProductoViewModel

    // Scanner de QR/barras
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Inicializar ViewModel — igual que en tus tareas
    ...
    private fun configurarBotonGuardar() {
        ...
        btnRegistrar.setOnClickListener {
            ...
            // Crear el objeto ProductoEntity
            ...
            // Guardar en la BD usando el ViewModel
